...
works.forEach(function (a) {
  return a.addEventListener("mouseover", hiddenFunction);
});
works.forEach(function (a) {
  return a.addEventListener("mouseout", hiddenFunction2);
});

function hiddenFunction() {
  var desc = document.querySelectorAll('.desc');
  desc.forEach(function (p) {
    return p.classList.toggle("ghost");
  });
}
...
function hiddenFunction2() {
  var desc = document.querySelectorAll('.desc');
  desc.forEach(function (p) {
    return p.classList.remove("ghost");
  });
} // Skills list
...
skills.forEach(function (a) {
  return a.addEventListener("mouseover", logoFunction);
});
skills.forEach(function (a) {
  return a.addEventListener("mouseout", logoRemoveFunction);
});

function logoFunction() {
  var logos = document.querySelectorAll('.logo');
  logos.forEach(function (p) {
    return p.classList.add("skill-mode");
  });
}
...
function logoRemoveFunction() {
  var logos = document.querySelectorAll('.logo');
  logos.forEach(function (p) {
    return p.classList.remove("skill-mode");
  });
} // Contact links
...
linke.addEventListener("mouseout", function (event) {
